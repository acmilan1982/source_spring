 ...
 */
 ...
 class TypeConverterDelegate {
     ...
     /**
        ...
        Params:
        oldValue – the previous value, if available (may be null) newValue – the proposed new value requiredType – the type we must convert to (or null if not known, for example in case of a collection element) editor – the PropertyEditor to use
        Returns:
        the new value, possibly the result of type conversion
        Throws:
        IllegalArgumentException – if type conversion failed
      */
     @Nullable
     private Object doConvertValue(@Nullable Object oldValue, 
                                   @Nullable Object newValue,
