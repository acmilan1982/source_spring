...
/**
	...
	Note that the MergedAnnotations model (which this interface has been designed for) always ignores lang annotations according to the PLAIN filter (for efficiency reasons). 
	Any additional filters and even custom filter implementations apply within this boundary and may only narrow further from here.
	Since:
	  5.2
	See Also:
	  MergedAnnotations
...
public interface AnnotationFilter {
	...
	/**
		...
		This is the default filter in the MergedAnnotations model.
	 */
