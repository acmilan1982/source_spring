 ...
 */
 ...
 public abstract class AbstractHandlerMethodMapping<T> extends AbstractHandlerMapping implements InitializingBean {
     ...
     /**
        ...
        See Also:
        getCandidateBeanNames(), processCandidateBean, 
      */
     // 代码10 
     ...
     /**
        Determine the type of the specified candidate bean and call detectHandlerMethods if identified as a handler type.
        This implementation avoids bean creation through checking org.springframework.beans.factory.BeanFactory.getType and calling detectHandlerMethods with the bean name.
        Params:
        beanName – the name of the candidate bean
        Since:
        5.1
        See Also:
        isHandler, detectHandlerMethods
      */
     // 代码15 
     protected void processCandidateBean(String beanName) {
         ...
         if (beanType != null && isHandler(beanType)) {   // 见子类RequestMappingHandlerMapping代码10
