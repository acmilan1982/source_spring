...
public class AnnotatedGenericBeanDefinition extends GenericBeanDefinition implements AnnotatedBeanDefinition {
	...
	public AnnotatedGenericBeanDefinition(Class<?> beanClass) {
		setBeanClass(beanClass);                                     // 设置当前bean的实现类，见 AbstractBeanDefinition 代码10

		/*   创建AnnotationMetadata对象，实现类为 StandardAnnotationMetadata
		 *   此时，会读取当前对象的所有注解，并缓存在AnnotationsScanner	
		 */
		this.metadata = AnnotationMetadata.introspect(beanClass);    // 见AnnotationMetadata代码10
	}
