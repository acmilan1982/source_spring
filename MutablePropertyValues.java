 ...
 */
 ...
 public class MutablePropertyValues implements PropertyValues, Serializable {
     ...
     /**
            ...
            replacing any existing one for the corresponding property or getting merged with it (if applicable).
            ...
            名值对，创建对应的PropertyValue，加入 propertyValueList
      */
      // 代码5
      public MutablePropertyValues add(String propertyName, @Nullable Object propertyValue) {
        addPropertyValue(new PropertyValue(propertyName, propertyValue)); // 见代码6
        return this;
     }
     ...
     /**
            ...
            Returns:
            this in order to allow for adding multiple property values in a 
      */
     // 代码6 
