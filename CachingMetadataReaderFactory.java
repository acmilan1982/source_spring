...
public class CachingMetadataReaderFactory extends SimpleMetadataReaderFactory {
	...
	@Nullable
	private Map<Resource, MetadataReader> metadataReaderCache;   // new LocalResourceCache(cacheLimit)
	...
	/**
		...
		This method enforces a local resource cache, even if the ResourceLoader supports a shared resource cache.
	 */
	// 代码1
	public void setCacheLimit(int cacheLimit) {
		if (cacheLimit <= 0) {
			...
			this.metadataReaderCache = new LocalResourceCache(cacheLimit);  // LocalResourceCache当前类的内部类
		}
	}
