...
public class Http11Processor extends AbstractProcessor {
    ...
    public Http11Processor(AbstractHttp11Protocol<?> protocol,   // ProtocolHandler对象，实现类为 Http11NioProtocol
                           Adapter adapter) {
        super(adapter);
        ...
        /**
         *    request：定义在父类中：protected final Request request;
         *             构造方法被实例化：org.apache.coyote.Request
         * 
         *    private final Http11InputBuffer inputBuffer;
         */
        inputBuffer = new Http11InputBuffer(request, 
                                            protocol.getMaxHttpRequestHeaderSize(),
                                            protocol.getRejectIllegalHeader(), 
                                            httpParser);
