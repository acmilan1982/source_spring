...
public class StandardPipeline extends LifecycleBase implements Pipeline {
    ...
    /**
        ...
        Prior to setting the basic Valve, the Valve's setContainer() will be called, if it implements Contained, with the owning Container as an argument. 
        The method may throw an IllegalArgumentException if this Valve chooses not to be associated with this Container, or IllegalStateException if it is already associated with a different Container.
    ...
    // 代码10
    @Override
    public void setBasic(Valve valve) {      // 假设Valve为：StandardContextValve
        ...
        // 设置Valve归属的容器对象，如 StandardContext
