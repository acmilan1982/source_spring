...
public class Connector extends LifecycleMBeanBase {
    ...
    // 根据协议，创建对应的ProtocolHandler，通常是org.apache.coyote.http11.Http11NioProtocol
    /**
    ...
    protected void initInternal() throws LifecycleException {
        ...
        try {
            protocolHandler.init();   // 定义在 Http11NioProtocol 的父类 AbstractHttp11Protocol
                                      // 见 AbstractHttp11Protocol 代码5
        } catch (Exception e) {
    ...
    protected void startInternal() throws LifecycleException {
        ...
        try {
            protocolHandler.start();       // 见 Http11NioProtocol 父类 AbstractProtocol 的start()方法
        } catch (Exception e) {
