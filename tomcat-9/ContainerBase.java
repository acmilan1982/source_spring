...
public abstract class ContainerBase extends LifecycleMBeanBase implements Container {
    ...
    /**
        ...
        Prior to adding this Container to the set of children, the child's setParent() method must be called, with this Container as an argument. 
        This method may thrown an IllegalArgumentException if this Container chooses not to be attached to the specified Container, in which case it is not added
        Params:
    ...
    private void addChildInternal(Container child) {
        ...
        fireContainerEvent(ADD_CHILD_EVENT,   // "addChild"
                           child);
    ...
    // 代码11
    @Override
    public void fireContainerEvent(String type,     // "addChild"
                                   Object data) {
