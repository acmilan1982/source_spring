...
public abstract class AbstractEndpoint<S,U> {
    ...
    /**
         Controls when the Endpoint binds the port. 
    ...
    /**
        ...
        Params:
        socketWrapper – The socket wrapper to process event – The socket event to be processed dispatch – Should the processing be performed on a new container thread
        Returns:
    ...
    public boolean processSocket(SocketWrapperBase<S> socketWrapper,  
        ...
        try {
            ...
            if (sc == null) {
                // 创建 SocketProcessor 对象，其实现了 Runnable 接口
                // 稍后会被扔到线程池中处理
    ...
    public final void start() throws Exception {
        ...
        startInternal();  // 见子类 NioEndpoint 代码10
    }
