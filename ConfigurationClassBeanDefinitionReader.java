...
import org.apache.commons.logging.Log;
 ...
 class ConfigurationClassBeanDefinitionReader {
     ...
     private void loadBeanDefinitionsForBeanMethod(BeanMethod beanMethod) {
         ...
         // 创建 BeanDefinition 对象，实现类为：ConfigurationClassBeanDefinition
         ...
         if (metadata.isStatic()) {
             ...
             // 向 ConfigurationClassBeanDefinition 中设置 factoryBeanName,factoryMethodName
         ...
         // ConfigurationClassBeanDefinition设置 Method 对象
