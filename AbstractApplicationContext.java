...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			/*
			 * 
			 *   2. 向 beanFactory 中注册系统属性，环境变量等，以bean的方式, 具体实现为 Map
			 */
			// Prepare the bean factory for use in this context.
			prepareBeanFactory(beanFactory);                                              // 见代码20
	...
	protected void prepareRefresh() {
		...
		// 当前类 initPropertySources() 为空方法，由子类实现
	...
	public ConfigurableEnvironment getEnvironment() {
		if (this.environment == null) {
			this.environment = createEnvironment();    // 见代码13
		}
	...
	protected ConfigurableListableBeanFactory obtainFreshBeanFactory() {
		refreshBeanFactory();            // 见子类 GenericApplicationContext 代码5
		return getBeanFactory();         // 见子类 GenericApplicationContext 代码6
	}
	...
	protected void invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory beanFactory) {
		...
		PostProcessorRegistrationDelegate.invokeBeanFactoryPostProcessors(beanFactory,                       // invokeBeanFactoryPostProcessors 见 PostProcessorRegistrationDelegate代码1
		                                                                  getBeanFactoryPostProcessors());   // getBeanFactoryPostProcessors获取所有BeanFactoryPostProcessor，见代码26
																		                                     // 通常，此时尚未注册任何 BeanFactoryPostProcessor
	...
	protected void finishBeanFactoryInitialization(ConfigurableListableBeanFactory beanFactory) {
		...
		/*
		    如果此时没有 BeanFactoryPostProcessor(比如：PropertySourcesPlaceholderConfigurer) 注册 embedded value resolver， 
			那么注册一个默认，主要用来解析注解的属性值
		...
		// Instantiate all remaining (non-lazy-init) singletons.
		beanFactory.preInstantiateSingletons();       // 见DefaultListableBeanFactory代码66
	}
