...
import java.util.ArrayList;
 ...
 public class DataBinder implements PropertyEditorRegistry, TypeConverter {
     ...
     /**
        ...
        This call can create field errors, representing basic binding errors like a required field (code "required"), 
        ...
        For efficiency, it will be modified to just contain allowed fields if it implements the MutablePropertyValues interface; 
        else, an internal mutable copy will be created for this purpose. 
        Pass in a copy of the PropertyValues if you want your original instance to stay unmodified in any case.
        Params:
     ...
     /**
        ...
        See Also:
        checkAllowedFields, checkRequiredFields, applyPropertyValues
      */
     // 代码11
     ...
     /**
        ...
        See Also:
        getRequiredFields, getBindingErrorProcessor, BindingErrorProcessor.processMissingFieldError
      */
