...
public class InjectionMetadata {
	...
	public void inject(Object target, 
		...
		// 遍历所有 InjectedElement 对象，执行其 inject 方法，
		if (!elementsToIterate.isEmpty()) {
			for (InjectedElement element : elementsToIterate) {
				element.inject(target, beanName, pvs);          // 见 AutowiredFieldElement 代码1
			}
		}
    ...
    /**
        ...
        Params:
          metadata – the existing metadata instance clazz – the current target class
        Returns:
          true indicating a refresh, false otherwise
        See Also:
          needsRefresh(Class)
    */
    // 代码5
