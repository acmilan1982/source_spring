...
public class StandardEnvironment extends AbstractEnvironment {
	...
	/**
		 Create a new StandardEnvironment instance with a default MutablePropertySources instance.
	 */
    // 构造方法
	...
	/**
		...
		See Also:
		AbstractEnvironment.customizePropertySources(MutablePropertySources), getSystemProperties(), getSystemEnvironment()
	 */
    // 代码1
	@Override
	protected void customizePropertySources(MutablePropertySources propertySources) {
		propertySources.addLast(new PropertiesPropertySource(SYSTEM_PROPERTIES_PROPERTY_SOURCE_NAME, getSystemProperties()));            // systemProperties
		propertySources.addLast(new SystemEnvironmentPropertySource(SYSTEM_ENVIRONMENT_PROPERTY_SOURCE_NAME, getSystemEnvironment()));   // systemEnvironment
	}
